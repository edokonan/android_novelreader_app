...
public class TxtConfig {
    ...
    public static  int DEFAULT_TEXT_SIZE = 47;//in px
    public static  int DEFAULT_BACKGROUND_COLOR = Color.parseColor("#d4c7a5");
    public static  int DEFAULT_TEXT_COLOR = Color.parseColor("#453e33");

    public int textSize = DEFAULT_TEXT_SIZE;//字体大小
    public int textColor = DEFAULT_TEXT_COLOR;//字体颜色
    public int backgroundColor = DEFAULT_BACKGROUND_COLOR;//背景颜色
    ...
    public static int getBackgroundColor(Context context) {
        SharedPreferences share = getS(context);
        return share.getInt(C_BACKGROUND_COLOR, DEFAULT_BACKGROUND_COLOR);
    }
    ...
    public static Boolean getCanPressSelect(Context context) {
        SharedPreferences share = getS(context);
        return share.getBoolean(C_CAN_PRESS_SELECT, false);
    }
