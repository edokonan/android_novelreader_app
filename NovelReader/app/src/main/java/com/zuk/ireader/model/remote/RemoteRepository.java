...
public class RemoteRepository {
    ...
    private Retrofit mRetrofit_novel;
    private BookApiNovel mBookApi_novel;
    ...
    private RemoteRepository(){
        ...
        mRetrofit_novel = RemoteHelperNovel.getInstance().getRetrofit();
        mBookApi_novel = mRetrofit_novel.create(BookApiNovel.class);
    }
    ...
    public Single<List<BookListBean>> getBookLists(String duration, String sort,
        ...
        Single<BookListPackage> list = mBookApi.getBookListPackage(duration, sort, start+"", limit+"", tag, gender);
        return list.map(bean -> bean.getBookLists());
    }


    public Single<NovelGenreBean> getBookListsNovel(String site, String genre){
        Single<NovelGenreBean> bean = mBookApi_novel.getBookListPackage(site, genre);
        return bean;
//        return  list.map(bean -> bean.getBookLists());
    }
    ...
    public Single<NovelInfoBean> getNovelDetail(String site, String link){
        return mBookApi_novel.getBookDetail(site,link);
    }
